...
impl AuthorizeWithSeed {
  pub fn instruction(&self, args: AuthorizeWithSeedInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AuthorizeWithSeedInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
/// Lockup authority, if updating `StakeAuthorize::Withdrawer` before lockup expiration
#[inline(always)]
    pub fn lockup_authority(&mut self, lockup_authority: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = AuthorizeWithSeed {
                              stake: self.stake.expect("stake is not set"),
                                        ...
                                        clock_sysvar: self.clock_sysvar.unwrap_or(solana_program::pubkey!("SysvarC1ock11111111111111111111111111111111")),
                                        lockup_authority: self.lockup_authority,
                      };
          let args = AuthorizeWithSeedInstructionArgs {
                                                              new_authorized_pubkey: self.new_authorized_pubkey.clone().expect("new_authorized_pubkey is not set"),
                                                                  stake_authorize: self.stake_authorize.clone().expect("stake_authorize is not set"),
                                                                  authority_seed: self.authority_seed.clone().expect("authority_seed is not set"),
                                                                  authority_owner: self.authority_owner.clone().expect("authority_owner is not set"),
                                    };
...
#[inline(always)]
    pub fn base(&mut self, base: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Clock sysvar
#[inline(always)]
    pub fn clock_sysvar(&mut self, clock_sysvar: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
/// Lockup authority, if updating `StakeAuthorize::Withdrawer` before lockup expiration
#[inline(always)]
    pub fn lockup_authority(&mut self, lockup_authority: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = AuthorizeWithSeedInstructionArgs {
                                                              new_authorized_pubkey: self.instruction.new_authorized_pubkey.clone().expect("new_authorized_pubkey is not set"),
                                                                  stake_authorize: self.instruction.stake_authorize.clone().expect("stake_authorize is not set"),
                                                                  authority_seed: self.instruction.authority_seed.clone().expect("authority_seed is not set"),
                                                                  authority_owner: self.instruction.authority_owner.clone().expect("authority_owner is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          clock_sysvar: self.instruction.clock_sysvar.expect("clock_sysvar is not set"),
