  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = DelegateStake {
                              stake: self.stake.expect("stake is not set"),
                                        ...
                                        stake_history: self.stake_history.unwrap_or(solana_program::pubkey!("SysvarStakeHistory1111111111111111111111111")),
...
#[inline(always)]
    pub fn stake_history(&mut self, stake_history: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Unused account, formerly the stake config
#[inline(always)]
    pub fn unused(&mut self, unused: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
