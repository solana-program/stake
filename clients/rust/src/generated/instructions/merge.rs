...
impl MergeBuilder {
  pub fn new() -> Self {
    Self::default()
            ...
            /// Destination stake account for the merge
#[inline(always)]
    pub fn destination_stake(&mut self, destination_stake: solana_program::pubkey::Pubkey) -> &mut Self {
...
/// Stake history sysvar that carries stake warmup/cooldown history
#[inline(always)]
    pub fn stake_history_sysvar(&mut self, stake_history_sysvar: solana_program::pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = Merge {
                              destination_stake: self.destination_stake.expect("destination_stake is not set"),
                                        ...
                                        stake_history_sysvar: self.stake_history_sysvar.unwrap_or(solana_program::pubkey!("SysvarStakeHistory1111111111111111111111111")),
...
impl<'a, 'b> MergeCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      /// Destination stake account for the merge
#[inline(always)]
    pub fn destination_stake(&mut self, destination_stake: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.destination_stake = Some(destination_stake);
                    self
    }
      /// Source stake account for to merge.  This account will be drained
#[inline(always)]
    pub fn source_stake(&mut self, source_stake: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn clock_sysvar(&mut self, clock_sysvar: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Stake history sysvar that carries stake warmup/cooldown history
#[inline(always)]
    pub fn stake_history_sysvar(&mut self, stake_history_sysvar: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          destination_stake: self.instruction.destination_stake.expect("destination_stake is not set"),
                  
          source_stake: self.instruction.source_stake.expect("source_stake is not set"),
                  
          clock_sysvar: self.instruction.clock_sysvar.expect("clock_sysvar is not set"),
                  
          stake_history_sysvar: self.instruction.stake_history_sysvar.expect("stake_history_sysvar is not set"),
