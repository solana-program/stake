  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = Initialize {
                              stake: self.stake.expect("stake is not set"),
                                        rent_sysvar: self.rent_sysvar.unwrap_or(solana_program::pubkey!("SysvarRent111111111111111111111111111111111")),
                      };
...
#[inline(always)]
    pub fn stake(&mut self, stake: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Rent sysvar
#[inline(always)]
    pub fn rent_sysvar(&mut self, rent_sysvar: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          rent_sysvar: self.instruction.rent_sysvar.expect("rent_sysvar is not set"),
                          __args: args,
            };
