...
mod test {
    ...
    use {
        super::*, crate::ulp::max_ulp_tolerance, proptest::prelude::*, std::ops::Div,
        test_case::test_case,
    };
    ...
    #[test_case(0, 10, 100; "account portion is zero")]
    #[test_case(5, 0, 100; "cluster portion is zero")]
    #[test_case(5, 10, 0; "cluster effective is zero")]
    fn activation_zero_cases_return_zero(
        ...
        assert_eq!(
            calculate_activation_allowance(0, account_portion, &prev, Some(0)),
            0
        );
    }
    ...
    fn cooldown_zero_cases_return_zero(
        ...
        assert_eq!(
            calculate_deactivation_allowance(0, account_portion, &prev, Some(0)),
            0
        );
    }
    ...
    #[test]
    fn cooldown_overflow_scenario_still_rate_limits() {
        // Extreme scenario where a single account holding nearly the total supply
        // and tries to deactivate everything at once. Asserting rate limiting is maintained.
        let supply_lamports: u64 = 400_000_000_000_000_000; // 400M SOL
        let account_portion = supply_lamports;
        let prev = StakeHistoryEntry {
        ...
        let actual_result = calculate_deactivation_allowance(
            100,
            account_portion,
            &prev,
            None, // forces 25% rate
