...
#[inline(always)]
    pub fn stake(&mut self, stake: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            /// Delinquent vote account for the delegated stake account
#[inline(always)]
    pub fn delinquent_vote(&mut self, delinquent_vote: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn new(
    ...
    Self {
      __program: program,
              ...
              delinquent_vote: accounts.delinquent_vote,
  ...
  pub fn invoke_signed_with_remaining_accounts(
    ...
    account_infos.push(self.__program.clone());
                  account_infos.push(self.stake.clone());
                        account_infos.push(self.delinquent_vote.clone());
...
#[inline(always)]
    pub fn stake(&mut self, stake: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Delinquent vote account for the delegated stake account
#[inline(always)]
    pub fn delinquent_vote(&mut self, delinquent_vote: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.delinquent_vote = Some(delinquent_vote);
                    self
    }
      /// Reference vote account that has voted at least once in the last `MINIMUM_DELINQUENT_EPOCHS_FOR_DEACTIVATION` epochs
#[inline(always)]
    pub fn reference_vote(&mut self, reference_vote: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          delinquent_vote: self.instruction.delinquent_vote.expect("delinquent_vote is not set"),
                  
          reference_vote: self.instruction.reference_vote.expect("reference_vote is not set"),
                    };
